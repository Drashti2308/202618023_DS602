...
from src.modeling import build_model, calculate_vif, create_diagnostic_plots
...
# ---------------------------------------------
    ...
    st.write(
        "These diagnostic plots are used to evaluate the assumptions "
        "of the multiple linear regression model."
    )

    # The function returns two values:
    # 1. Matplotlib figure
    # 2. Jarque-Bera test result
    diagnostic_fig, jb_result = create_diagnostic_plots(model)
    ...
    if jb_result.pvalue > 0.05:
        ...
        st.warning(
            ...
            "because the p-value is less than or equal to 0.05."
        )
